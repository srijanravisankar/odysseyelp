# The Odyssey Yelp - Application Features & Functionality

## Overview

**The Odyssey Yelp** is a collaborative trip planning and discovery application that helps users create, share, and explore real-world location itineraries. It combines AI-powered itinerary generation with interactive mapping, group collaboration, and social discovery features.
...
- **Collaborative Editing**: Real-time collaborative itinerary editing
- **Social Features**: User profiles, followers, activity feeds
- **Itinerary Ratings**: User reviews and ratings for discovered trips
