...
import {MoreHorizontal, MessageSquare, Clock, Bot} from "lucide-react"
                ...
                <div className="flex-1 space-y-1 overflow-y-auto pr-1">
                    {mockHistory.map((item) => (
                        <div
                            ...
                            tabIndex={0}
                            className={cn(
                                "group flex w-full cursor-pointer items-center gap-2 rounded-md px-2 py-2 text-left text-xs transition",
                                item.isActive
                        ...
                        >
                            ...
                            <div className="flex min-w-0 flex-1 flex-col">
                                ...
                                <span className="text-[11px] font-medium leading-tight line-clamp-2 break-words">
                  {item.title}
                </span>
