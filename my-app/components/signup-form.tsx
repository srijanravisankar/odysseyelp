...
export function SignupForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (user) {
        // Manually create user profile (since trigger is having issues)
        try {
      ...
      const errorMessage = error?.message || error?.error_description || JSON.stringify(error) || 'Failed to create account'
